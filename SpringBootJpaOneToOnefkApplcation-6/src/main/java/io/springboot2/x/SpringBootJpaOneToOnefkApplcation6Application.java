...
public class SpringBootJpaOneToOnefkApplcation6Application implements ApplicationRunner {

	@Autowired
	private ApplicationContext ctx;
	
	public static void main(String[] args) {
		SpringApplication.run(SpringBootJpaOneToOnefkApplcation6Application.class, args);
	}
